...
export default function CodeTutorial() {
  const initialCode = `<h1 class="text-red-500">Hello World</h1>`;
  const [codeToDisplay, setCodeToDisplay] = useState<string>(initialCode);
  const [codeTutorial, setCodeTutorial] = useState(``);
  useCopilotReadable({
    description: "Current code being displayed",
    value: codeToDisplay,
  });
  useCopilotAction(
    {
